        ...
        <footer className="bg-[#243128] mt-24 text-white">
            <div className='container mx-auto pt-20'>
                ...
                <div className="flex justify-between border-b-2 pb-16">
                    <div className="w-[25%] bg-red py-3 text-sm font-thin">
                        <small>
                    ...
                    <div className="w-[15%] bg-blue-">
                        <h1 className='text-lg font-bold py-3'>CORPORATE</h1>
                        <ul className='uppercase text-xs font-medium leading-6'>
                    ...
                    <div className="w-[15%]">
                        ...
                        <ul className='upercase text-xs font-medium leading-6'>
                    ...
                    <div className="w-[17%]">
                        ...
                        <ul className='flex gap-4 mt-2 '>
                            <li className='border-none'><a href="https://apps.apple.com/id/app/kulo/id1517045320"><i class="fa-brands fa-apple fa-2xl icon"></i></a></li>
                            <li className='border-none'><a href="https://www.instagram.com/kedaikopikulo/?hl=en"><i class="fa-brands fa-google-play fa-2xl icon"></i></a></li>
                        </ul>
                    </div>
                </div>
